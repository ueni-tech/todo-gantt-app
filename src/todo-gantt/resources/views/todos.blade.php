...
<x-app-layout>
  <x-sidebar />
  <div x-data="{modalOpened : false, toggleModal(){this.modalOpened = !this.modalOpened}}" class="ml-16 h-screen pt-[64px]">
    <div class="w-[95%] h-full mx-auto py-6 flex justify-items-start gap-3 overflow-x-auto">
      <div class="w-56 h-full py-2 px-4 bg-zinc-300 rounded">
        ...
        <ul class="todo-list-height overflow-y-auto flex flex-col gap-3 hidden-scrollbar hidden-scrollbar::-webkit-scrollbar">
          <li>
            <button @click="toggleModal()" class="w-full p-2 bg-neutral-100 rounded flex items-center gap-1">
    ...
    <div class="hidden transition" :class="{'hidden': !modalOpened}">
